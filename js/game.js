...
var notes1 = 
[
    new Note('assets/img/whole_note.png', 'assets/snd/whole_note1.wav', 590, 1060),
    new Note('assets/img/whole_note.png', 'assets/snd/whole_note2.wav', 900, 1015),
...
var notes3 = [
    new Note('assets/img/quarter_note.png', 'assets/snd/quarter_note1.wav', 620, 510),
    new Note('assets/img/quarter_note.png', 'assets/snd/quarter_note2.wav', 430, 550),
    new Note('assets/img/quarter_note.png', 'assets/snd/quarter_note3.wav', 70, 600),
    new Note('assets/img/quarter_note.png', 'assets/snd/quarter_note4.wav', 70, 940),
    new Note('assets/img/quarter_note.png', 'assets/snd/quarter_note5.wav', 450, 960),
    new Note('assets/img/quarter_note.png', 'assets/snd/quarter_note6.wav', 200, 800),
    new Note('assets/img/quarter_note.png', 'assets/snd/quarter_note7.wav', 450, 770),
    new Note('assets/img/quarter_note.png', 'assets/snd/quarter_note8.wav', 290, 630),
    
];
var notes4 = [
    new Note('assets/img/crochet_note.png', 'assets/snd/crochet_note1.wav', 450, 660),
    new Note('assets/img/crochet_note.png', 'assets/snd/crochet_note2.wav', 524, 740),
    new Note('assets/img/crochet_note.png', 'assets/snd/crochet_note3.wav', 524, 900),
    new Note('assets/img/crochet_note.png', 'assets/snd/crochet_note4.wav', 524, 1060),
